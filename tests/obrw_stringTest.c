...
void parseConfigFileFor_quotationMarkStringInStringWithoutSpaces_expectedString() {
    printf(
        "%s - "
        "parseConfigFileFor_quotationMarkStringInStringWithoutSpaces_"
        "expectedString\n",
        OBRW_STRINGTEST_CLASS_NAME);
...
void parseConfigFileFor_quotationMarkStringInStringWithSpaces_expectedString() {
    printf(
        "%s - "
        "parseConfigFileFor_quotationMarkStringInStringWithSpaces_"
        "expectedString\n",
        OBRW_STRINGTEST_CLASS_NAME);
...
void parseConfigFileFor_quotationMarkStringWithSpacesInStringWithSpaces_expectedString() {
    printf(
        "%s - "
        "parseConfigFileFor_quotationMarkStringWithSpacesInStringWithSpaces_"
        "expectedString\n",
        OBRW_STRINGTEST_CLASS_NAME);
...
void parseConfigFileFor_StringWithOneQuotationMarkStart_expectedNullResult() {
    printf(
        "%s - "
        "parseConfigFileFor_StringWithOneQuotationMarkStart_"
        "expectedNullResult\n",
        OBRW_STRINGTEST_CLASS_NAME);
 ...
 * After a compare of <code>strncpy</codo> and <code>strncat</code>, it seems,
 * that <code>strncat</code> works correctly. After a nice format of the
 * compare, both work like expected ... -> :? <p> Setup was:
...
void parseConfigFileFor_possibleWallpaperDirectorySetStringOfUser_expectedPathStringResult() {
    printf(
        "%s - "
        "parseConfigFileFor_possibleWallpaperDirectorySetStringOfUser_"
        "expectedPathStringResult\n",
        OBRW_STRINGTEST_CLASS_NAME);

    const char* str =
        "wpDir = \"/home/user/.config/wallpaper-directory/1024x768/\"";
...
void getCountOfChar_stringWithTwoSymbolsOnlyAndSymbol_expectedResultIsTwo() {
    printf(
        "%s - "
        "getCountOfChar_stringWithTwoSymbolsOnlyAndSymbol_"
        "expectedResultIsTwo\n",
        OBRW_STRINGTEST_CLASS_NAME);
