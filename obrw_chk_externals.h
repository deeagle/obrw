 ...
 *
 * \brief The file includes the definitons of functions which checks, if needed external dependencies are avaiable.
 *
 */
 ...
 * 
 * \return The function returns 1 if feh is installed (bin at /usr/bin/feh) and 0 if it's not installed.
 * \retval 1 true
 * \retval 0 false
 */
